...
function init() {
    ...
    // Create an array to populate with future iframe objects.
    // Pull out of local storage an array of previous logged messages, or declare an empty array for future ones.
    // Set counter of iframes objects.
...
////////////////////////////////////////////
    ...
    document.querySelector('.generate-button').addEventListener("click", generateIframe, false);
